...
public class FluxTest {
    ...
    /**
     * This test will emit the elements in the flux and log out each event
     */
    @Test
    void firstFlux() {
        Flux.just("A", "B", "C")
    ...
    /**
     * This test demonstrates creating a Flux from a Collection / Iterable.  Note we can't use Flux.just(Iterable)
     */
    @Test
  ...
  /**
   * Same as the test above, it will
   */
  @Test
    void fluxFromRange() {
        Flux.range(10, 5)
